...
class ModelEvaluator:
    def __init__(
        self, model_checkpoint_path: str, model_config_path: str, device: str = "auto"
    ):
        configs = None
        try:
    ...
    @torch.no_grad()
    def eval(self, dataset: CharDataset) -> dict[str, float]:
        self.model.eval()
...
if __name__ == "__main__":
    ...
    max_size = 1000
    data = full_text[max_size : max_size + 100]
